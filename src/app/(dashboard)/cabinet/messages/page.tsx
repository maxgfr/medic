...
export default function CabinetMessagesPage() {
	...
	const { data: activeConversations, isLoading: loadingActiveConversations } =
	...
	const {
		...
		isLoading: loadingArchivedConversations,
	} = api.messages.getConversations.useQuery({
		limit: 50,
		offset: 0,
		showArchived: true,
	...
	const conversations =
		activeTab === "active" ? activeConversations : archivedConversations;
	const loadingConversations =
		activeTab === "active"
			? loadingActiveConversations
			: loadingArchivedConversations;
	...
	const toggleArchiveMutation = api.messages.toggleArchive.useMutation({
		onSuccess: () => {
			...
			// Invalidate both active and archived conversations to refresh the lists
			api.useUtils().messages.getConversations.invalidate();
		},
		onError: (error) => {
			toast.error(error.message);
		},
			...
			>
												...
												<div className="mb-2 flex items-start justify-between">
													<div>
														...
														<p className="text-gray-500 text-xs">
															{conversation.doctor.experienceYears} ans
															d'expérience
														</p>
													</div>
									...
									<Card>
										<CardContent className="p-8 text-center">
											...
											<p className="text-gray-600">
												Les conversations avec les médecins apparaîtront ici
												lorsque vous accepterez leurs candidatures.
											</p>
										</CardContent>
									</Card>
								)}
														...
														<div className="grid grid-cols-2 gap-4">
															<div className="flex items-center gap-2">
																...
																<span className="text-sm">
																	{conversationDetails.doctor.experienceYears}{" "}
																	ans d'expérience
																</span>
															</div>
															<div className="flex items-center gap-2">
				...
				<TabsContent value="archived" className="mt-0">
					<div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
						...
						{/* Messages Panel for archived conversations */}
						<div className="lg:col-span-2">
							{selectedConversation && conversationDetails ? (
								<Card className="flex h-[600px] flex-col">
									<CardHeader className="border-b">
									...
									{/* Info message for archived conversations */}
									<div className="border-t p-4">
										<div className="rounded-lg bg-gray-50 p-3 text-center">
											<p className="text-gray-600 text-sm">
												Cette conversation est archivée. Désarchivez-la pour
								...
								<Card className="flex h-[600px] items-center justify-center">
									<div className="text-center">
										...
										<h3 className="mb-2 font-semibold text-gray-900 text-xl">
											Sélectionnez une conversation archivée
										</h3>
										<p className="text-gray-600">
											Choisissez une conversation archivée dans la liste pour la
											consulter.
										</p>
									</div>
								</Card>
